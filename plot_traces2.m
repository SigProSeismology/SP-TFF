function plot_traces2(t,r,z,rect_L,recr_L,recz_L,rect_R,recr_R,recz_R)
mi=min([min(t),min(r),min(z)]);     ma= max([max(t),max(r),max(z)]);
figure


subplot 321; plot(t, 'Color', [150 150 150]/255,'LineWidth',1); axis tight; grid on;  title('(a)');set(gca,'xticklabel',{[]});set(gca,'FontSize',15);
...
subplot 324; plot(r, 'Color', [150 150 150]/255,'LineWidth',1); axis tight; grid on;  title('(d)'); set(gca,'xticklabel',{[]});set(gca,'FontSize',15);
ylim([mi ma]) ;  hold on ; plot(recr_R, 'Color', [0 0 0]/255,'LineWidth',1); hold off
subplot 326; plot(z, 'Color', [150 150 150]/255,'LineWidth',1); axis tight; grid on;  title('(f)');set(gca,'FontSize',15);
