function F_A = Rectilinearity(SEMI,alpha,beta,ind)
% Rectilinearity: A code to apply rectilinearity filtering to extract
% Rayleigh waves
% F_A = Rectilinearity(SEMI,alpha,beta,ind)
%
% 
...
for i = 1 : size(A,1)
    for j = 1 : size(A,2)
        A(i,j)=(SEMI(11,i,j)+SEMI(12,i,j))/SEMI(10,i,j);
